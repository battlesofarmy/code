...
export default function Card_3() {
  return (
	...
	<div className="flex items-center justify-between p-3">
		...
		<Image alt="img" width={60} height={60} className="object-cover dark:bg-gray-500" src="https://i.ibb.co.com/k6xTr4kw/img.jpg"  />
	...
	<div className="p-3">
		...
		<Image alt="img" width={50} height={50} className="object-cover pr-1 dark:bg-gray-500" src="https://i.ibb.co.com/k6xTr4kw/img.jpg"  />
		<Image alt="img" width={30} height={30} className="object-cover dark:bg-gray-500" src="https://i.ibb.co.com/k6xTr4kw/img.jpg"  />
